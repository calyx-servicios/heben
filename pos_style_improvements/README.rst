======================
Pos Style Improvements
======================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !!  change in styles from pos                     !!
   !!                                                !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
This module extends the functionality of change in styles from pos
...
# go to apps > search "pos_style_improvements" > press install

Usage
=====

1. change in styles from pos
...
This module is part of the `gualok <https://github.com/calyx-servicios/heben>`_ project on Github.