========================
Stock move invoice group
========================

.. !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   !!This module adds the creation of invoices by    !!
   !! grouped stock moves                            !!
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
...
This module adds the creation of invoices by grouped stock moves.

Install
=======

* Go to applications > Find module "stock_move_invoice_group" > Press Install

* Go to Stock > Operations > Stock moves > and see the modifications
